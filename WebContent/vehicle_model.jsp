...
<title>ข้อมูลรุ่นรถ</title>
<jsp:include page="header_form.jsp"></jsp:include>
<script src="jsform/vehicle_model.js" type="text/javascript"></script>
</head>
<body>
	<div class="container"><p>
	<div class="row form-group"></div>
		<div class="panel panel-primary">
			<div class="panel-heading">ข้อมูลรุ่นรถ</div>
			<div class="panel-body form-horizontal">
				<div class="row form-group">
					<div class="col-xs-6 col-sm-3 text-right">
						<label class="control-label">รหัสรุ่นรถ</label>
					</div>
					<div class="col-xs-6 col-sm-3">
						<input type="text" id="vehicle_model_id" name="vehicle_model_id" class="form-control" readonly="readonly"> 
					</div>			
				...
				<div class="row form-group">
					<div class="col-xs-6 col-sm-3 text-right">
						<label class="control-label">ชื่อรุ่นรถ</label>
					</div>
					<div class="col-xs-6 col-sm-9">
		  				<input type="text" id="vehicle_model_name" name="vehicle_model_name" class="form-control" onkeypress="vehicleModelKeyPress()"/>
					</div>
				</div>
				<!-- End Row -->
