...
<script src="jsform/unit.js" type="text/javascript"></script>
</head>
<body>
	<div class="container"><p>
	<div class="row form-group"></div>
		<div class="panel panel-primary">
			<div class="panel-heading">ข้อมูลหน่วยนับสินค้า</div>
			<div class="panel-body form-horizontal">
				<div class="row form-group">
					<div class="col-xs-6 col-sm-3 text-right">
						<label class="control-label">รหัสหน่วยนับสินค้า</label>
					</div>
					<div class="col-xs-6 col-sm-3">
						<input type="text" id="unit_id" name="unit_id" class="form-control" readonly="readonly"> 
					</div>			
				...
				<div class="row form-group">
					<div class="col-xs-6 col-sm-3 text-right">
						<label class="control-label">ชื่อหน่วยนับสินค้า</label>
					</div>
					<div class="col-xs-6 col-sm-9">
		  				<input type="text" id="unit_name" name="unit_name" class="form-control" onkeypress="unitKeyPress()"/>
					</div>
				</div>
				<!-- End Row -->
