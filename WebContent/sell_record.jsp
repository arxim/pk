...
<title>ประวัติขายสินค้า</title>
<jsp:include page="header_form.jsp"></jsp:include>
<script src="jsform/sell_record.js"></script>
</head>
<body>	
	<form role="form" id="sell_record" name="sell_record">
	<div class="container">
	<div class="row form-group"></div>
		<div class="panel panel-primary">
			<div class="panel-heading">รายการประวัติขายสินค้า</div>
			<div class="panel-body form-horizontal">
				...
				<div class="panel-body form-horizontal">
			        ...
			        <thead>
			            <tr>
				            <th>วันที่บันทึกขาย</th><th>วันที่ขาย</th><th>ลูกค้า</th><th>Part No.</th><th>ชื่อสินค้า</th>
				            <th>รุ่นรถ</th><th>ยี้ห้อสินค้า</th><th>จำนวนขาย</th><th>ราคา/หน่วย</th><th>เป็นเงิน</th>
				            <th>ส่วนลด%</th><th>ส่วนลดบาท</th><th>ภาษี</th><th>ราคาสุทธิ/หน่วย</th><th>ราคารวมสุทธิ</th>
				            <th>ชนิดสินค้า</th><th>ประเภทสินค้า</th><th>ใบขายชั่วคราว</th>
			            </tr>
			        </thead>
			    	</table>
				</div>
