...
<title>ข้อมูลเขตพื้นที่</title>
<jsp:include page="header_form.jsp"></jsp:include>
<script src="jsform/area.js" type="text/javascript"></script>
</head>
<body>
	<div class="container"><p>
	<div class="row form-group"></div>
		<div class="panel panel-primary">
			<div class="panel-heading">ข้อมูลเขตพื้นที่</div>
			<div class="panel-body form-horizontal">
				<div class="row form-group">
					<div class="col-xs-6 col-sm-3 text-right">
						<label class="control-label">รหัสเขตพื้นที่</label>
					</div>
					<div class="col-xs-6 col-sm-3">
						<input type="text" id="area_id" name="area_id" class="form-control" readonly="readonly"> 
					</div>			
				...
				<div class="row form-group">
					<div class="col-xs-6 col-sm-3 text-right">
						<label class="control-label">ชื่อเขตพื้นที่</label>
					</div>
					<div class="col-xs-6 col-sm-9">
		  				<input type="text" id="route_name" name="route_name" class="form-control" onkeypress="routeNameKeyPress()"/>
					</div>
				</div>
				<!-- End Row -->
