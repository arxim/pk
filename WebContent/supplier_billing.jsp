...
<title>รายการวางบิลซื้อสินค้า</title>
<jsp:include page="header_form.jsp"></jsp:include>
<script src="jsform/supplier_billing.js"></script>
<style>
...
<body>
	<form role="form" id="supplier_billing" name="supplier_billing">
	<input id="invoiceType" name="invoiceType" type="hidden" value="supplier_billing"/>
	<input id="employee" name="employee" type="hidden"/>
	<input id="report_name" name="report_name" type="hidden" value="supplier_billing"/>

	<div class="container">
	<div class="row form-group"></div>
		<div class="panel panel-primary">
			<div class="panel-heading">รายการวางบิลซื้อสินค้า</div>
			<div class="panel-body form-horizontal">
				...
				<div class="panel-heading">รายละเอียดรายการวางบิลซื้อสินค้า</div>
				<div class="panel-body form-horizontal">
