...
<script src="jsform/buy_form_main.js"></script>
</head>
<body>	
	<form role="form" id="buy_form_main" name="buy_form_main" method="post" action="buy_form_detail.jsp" target="buy_form_detail">
	<!-- hidden form value -->
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body form-horizontal">
				...
				<div class="row form-group">
					...
					<div class="col-xs-6 col-sm-3">
						<input type="text" id="payment_date" data-provide="datepicker" class="form-control datepicker" placeholder="dd/mm/yyyy"> 
					</div>
				</div>
				<!-- End Row -->
				...
				<div class="col-xs-6 col-sm-2">
					<button type="button" id="btn_new" name="btn_new" class="btn btn-success pull-left" onclick="openFormDetail(event)"><span class="glyphicon glyphicon-plus-sign"></span> เพิ่มรายการ</button>
				</div>
				<div class="col-xs-6 col-sm-2">
