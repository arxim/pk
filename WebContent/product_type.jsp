...
<title>ข้อมูลประเภทสินค้า</title>
<jsp:include page="header_form.jsp"></jsp:include>
<script src="jsform/product_type.js" type="text/javascript"></script>
</head>
<body>
	<div class="container"><p>
	<div class="row form-group"></div>
		<div class="panel panel-primary">
			<div class="panel-heading">ข้อมูลประเภทสินค้า</div>
			<div class="panel-body form-horizontal">
				<div class="row form-group">
					<div class="col-xs-6 col-sm-3 text-right">
						<label class="control-label">รหัสประเภทสินค้า</label>
					</div>
					<div class="col-xs-6 col-sm-3">
						<input type="text" id="prd_type_id" name="prd_type_id" class="form-control" readonly="readonly"> 
					</div>			
				...
				<div class="row form-group">
					...
					<div class="col-xs-6 col-sm-9">
		  				<input type="text" id="prd_type_name" name="prd_type_name" class="form-control" onkeypress="productTypeKeyPress()"/>
					</div>
				</div>
				<!-- End Row -->
