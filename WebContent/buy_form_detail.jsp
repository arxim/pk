...
<title>รายละเอียดซื้อสินค้า</title>
...
<script src="jsform/buy_form_detail.js" type="text/javascript"></script>
</head>
<body>
	<form role="form" id="buy_form_detail" name="buy_form_detail" method="post" action="buy_form_detail.jsp" target="buy_form_detail">
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body form-horizontal">
				...
				<div class="row form-group">
					...
					<div class="col-xs-6 col-sm-3">
						<input type="text" id="invoice_no" name="invoice_no" class="form-control" required="required">
					</div>
				...
				<div class="row form-group">
					...
					<div class="col-xs-6 col-sm-9">
						<input type="text" id="sup_addr" name="sup_addr" class="form-control">
					</div>
				</div>
				<!-- End Row -->
				...
				<div class="row form-group">
					...
					<div class="col-xs-6 col-sm-9">			
    					<input type="text" id="sremark" name="sremark" class="form-control" readonly="readonly">
  					</div>
				</div>
				<!-- End Row -->
				
				<ul class="breadcrumb"><li class="active">รายละเอียดการซื้อสินค้า</li></ul>
				...
				<div class="row form-group">	
					<div class="col-xs-6 col-sm-3 text-right"><label class="control-label ">ราคาซื้อล่าสุด</label></div>				
					<div class="col-xs-6 col-sm-3">
						<div class="input-group">
					  		<input type="text" id="last_buy_price" name="last_buy_price" class="form-control" readonly="readonly"/>
	  						<span class="input-group-addon">บาท</span>
						</div>
					</div>
					<div class="col-xs-6 col-sm-3 text-right"><label class="control-label ">ส่วนลดล่าสุด</label></div>				
					<div class="col-xs-6 col-sm-3">
						<div class="input-group">
							<input type="text" id="last_discount" name="last_discount" class="form-control" readonly="readonly"> 
  							<span class="input-group-addon">บาท</span>
						</div>
					</div>
				</div>
