...
<script src="jsform/product_brand.js" type="text/javascript"></script>
</head>
<body>
	<div class="container"><p>
	<div class="row form-group"></div>
		<div class="panel panel-primary">
			<div class="panel-heading">ข้อมูลยี่ห้อสินค้า</div>
			<div class="panel-body form-horizontal">
				<div class="row form-group">
					<div class="col-xs-6 col-sm-3 text-right">
						<label class="control-label">รหัสยี่ห้อสินค้า</label>
					</div>
					<div class="col-xs-6 col-sm-3">
						<input type="text" id="prd_brand_id" name="prd_brand_id" class="form-control" readonly="readonly"> 
					</div>			
				...
				<div class="row form-group">
					<div class="col-xs-6 col-sm-3 text-right">
						<label class="control-label">ชื่อยี่ห้อสินค้า</label>
					</div>
					<div class="col-xs-6 col-sm-9">
		  				<input type="text" id="prd_brand_name" name="prd_brand_name" class="form-control" onkeypress="productBrandKeyPress()"/>
					</div>
				</div>
				<!-- End Row -->
